...
public class EmpresasController implements Serializable {
    ...
    @EJB
    private com.empyme.bogota.facade.EmpresasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("EmpresasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("EmpresasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("EmpresasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
