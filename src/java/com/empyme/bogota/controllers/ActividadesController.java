...
public class ActividadesController implements Serializable {
    ...
    @EJB
    private com.empyme.bogota.facade.ActividadesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("ActividadesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("ActividadesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle/Mensajes").getString("ActividadesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
